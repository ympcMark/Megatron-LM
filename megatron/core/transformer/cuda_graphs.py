...
def _get_gtp_persistent_buffer_max_inflight(gtp_backward_runners):
    ...
    # one configured local-CG module, while two covers normal multi-module pipelines.
    # Larger values only allow more graphs to stay live and increase persistent memory.
